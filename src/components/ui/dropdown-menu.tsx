...
function DropdownMenuTrigger({
  ...
  return (
    <MenuPrimitive.Trigger
      ...
      className={cn(
        "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 rounded-lg border border-transparent bg-clip-padding text-sm font-medium outline-none select-none transition-colors",
    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "z-[100] max-h-(--available-height) min-w-40 w-(--anchor-width) max-w-[calc(100vw-1.5rem)] origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-lg outline-none",
