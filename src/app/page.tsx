    ...
    <div className="flex flex-col flex-1 bg-zinc-50 font-sans dark:bg-black">
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-10 px-6 py-20">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          <a href="/dashboard" className="font-medium text-zinc-900 underline-offset-4 hover:underline dark:text-zinc-50">
            Open the full planner dashboard
          </a>{" "}
          after you sign in (goals, tasks, finance, habits, journal, notes, calendar).
        </p>
